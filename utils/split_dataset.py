...
def split_dataset_stratified(data_root: str = DATA_ROOT, 
    ...
    print("\nClass distribution:")
    for split_name, split_ids, split_labels in [("Train", train_ids, train_labels),
...
def save_splits_to_csv(train_ids, val_ids, test_ids, train_labels, val_labels, test_labels, output_dir: str = "."):
...
if __name__ == "__main__":
    # Split the dataset
    train_ids, val_ids, test_ids, train_labels, val_labels, test_labels = split_dataset_stratified(
        data_root=DATA_ROOT,
        classes=CLASSES,
        train_ratio=0.8,
        val_ratio=0.1,
    ...
    # Save to CSV files
    save_splits_to_csv(train_ids, val_ids, test_ids, train_labels, val_labels, test_labels, output_dir=PROJECT_ROOT / "dataset" / "splits")
